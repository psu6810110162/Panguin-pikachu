...
if __name__ == "__main__":
    ...
    # bootstrap ตาราง (dev/first deploy) — DB ที่มีข้อมูลจริงอยู่แล้วให้ใช้ `flask db upgrade`
    # แทน ไม่ใช่รัน python -m server ทับ (ดู server/__init__.py::create_all_tables)
