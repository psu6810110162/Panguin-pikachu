...
> เอกสารนี้อธิบาย **เกมที่มีอยู่จริงตอนนี้** ส่วนดีไซน์เป้าหมายเต็มรูปแบบ (dual meter, Y-Junction, หัวใจ, ไอเทม, boss 3 เวฟ, DAG report card) ดู **[docs/GAME_DESIGN.md](docs/GAME_DESIGN.md)** (GDD V.2) + [docs/OVERVIEW.md](docs/OVERVIEW.md) — ยังอยู่ระหว่างพัฒนาตาม [docs/SPRINT_2DAY.md](docs/SPRINT_2DAY.md) เพื่อไม่ให้เอกสารเพี้ยนไปจากของจริงเมื่อ build
